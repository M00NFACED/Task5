package ru.vsu.cs.pekshev.T5.tree.bst;

import java.util.Collection;
import java.util.Iterator;
import java.util.Map;
import java.util.Set;
import ru.vsu.cs.pekshev.util.dummy.DefaultNotSupportedCollection ;
import ru.vsu.cs.pekshev.util.dummy.DefaultNotSupportedSet ;
import ru.vsu.cs.pekshev.util.dummy.DefaultNotSupportedSortedMap ;
